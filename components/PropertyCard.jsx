    ...
    return ( 
        ...
        <div className="bg-white rounded-xl shadow-md relative">
            ...
            <div className="p-4">
              ...
              >
                <p><FaMoneyBill className="md:hidden lg:inline" /> {property.rates.weekly} Weekly</p>
                <p><FaMoneyBill className="md:hidden lg:inline" /> {property.rates.monthly} Monthly</p>
              </div>
